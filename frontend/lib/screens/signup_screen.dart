  ...
  Future<void> _signup() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Backend not reachable. Bypassing demo registration! 🌱")),
      );
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const MainLayout()),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text("Create an account to start growing", style: TextStyle(color: Colors.grey)),
